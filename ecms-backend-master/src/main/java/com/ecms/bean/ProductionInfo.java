...
public class ProductionInfo extends BaseInfo {

	private Integer id; //id
	private String checkNumber;  //检测编号checkOrder
	...
	public String getFinishProductNumber() {
		return finishProductNumber;
	}

	public void setFinishProductNumber(String finishProductNumber) {
