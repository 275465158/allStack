          ...
          <el-row :gutter="30">
            <el-col :span="12">
              <el-form-item label="出库单号">
                <el-input v-model="pickingForm.pickingCode" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="领料用途">
                <el-input v-model="pickingForm.useage" disabled></el-input>
              </el-form-item>
            </el-col>
            <!--<el-col :span="12">
              <el-form-item label="生产单号">
                <el-input v-model="pickingForm.productionId" disabled></el-input>
              </el-form-item>
            </el-col>-->
          </el-row>
          <el-row :gutter="30">
            <el-col :span="12">
              <el-form-item label="操作人">
                <el-input v-model="pickingForm.preparedBy" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="领料人">
                <el-input v-model="pickingForm.pickedBy" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="30">
            <el-col :span="12">
              <el-form-item label="领料时间">
                <el-date-picker value-format="yyyy-MM-dd" v-model="pickingForm.pickDate" disabled></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="出库状态">
                <el-select v-model="pickingForm.pickingStatus" placeholder="请选择" disabled>
  ...
  methods: {
    ...
    getData() {
      ...
      if (this.$route.query.pickingId != undefined) {
        this.search.pickingId = this.$route.query.pickingId;
        ...
        this.$http
          .post("/materiel/picking/detail/listByPickingId", this.search)
          .then(res => {
            if (res != undefined && res.data.code == 1000) {
    ...
    insertPicking() {
      this.$http
        .post("/materiel/picking/saveOrUpdate", this.pickingForm)
        .then(res => {
          if (res != undefined && res.data.code == 1000) {
            this.pickingForm = res.data.data;
            this.tableData.forEach(detail => {
              detail.materielId = detail.materielInventory.id;
              detail.pickingId = res.data.data.id;
              delete detail.materielInventory;
              delete detail.pickingList;
              this.$http
                .post("/materiel/picking/detail/saveOrUpdate", detail)
                .then(res => {
                  if (res != undefined && res.data.code == 1000) {
                  }
                });
