    ...
    <div class="container">
        ...
        <div class="materialList">
            <div class="handle-box" style="margin-top: 10px">
                <span class="text">物料材料列表</span>
                <el-button round type="primary" @click="add" style="margin-bottom: 10px">新增物料材料</el-button>
            </div>
            <div class="materialTable">
                <el-table v-loading="loading" :data="tables" border style="width:100%">
                    ...
                    <el-table-column label="物料材料编号" prop="number" align="center"></el-table-column>
                    <el-table-column label="物料材料名称" prop="type" align="center"></el-table-column>
        ...
        <el-dialog title="新增物料材料" @close="closeing" :visible.sync="editVisible" width="24%">
            <el-form ref="addForm" :rules="rules" :model="addForm" label-width="120px">
                <el-form-item label="物料材料编号:" prop="number">
                    <el-input :maxlength="2" style="width: 215px;" v-model="addForm.number"></el-input>
                </el-form-item>
                <el-form-item label="物料材料名称:" prop="type">
...
<script>
    export default {
        ...
        methods: {
            ...
            getData(){
                this.search.productNameId = this.$route.query.row.id;
                ...
                this.$http.post('/productOriginal/searchProductOriginalPager', this.search).then((res) => {
            ...
            updateStatus(index, row) {
                this.$http.post('/productOriginal/status/update', {
                    id: row.id
                }).then((res) => {
                    if (res != undefined && res.data.code == 1000) {
            ...
            insert(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.addForm.productNameId = this.$route.query.row.id;
                        this.$http.post('/productOriginal/insertProductOriginal', this.addForm).then((res) => {
                            if (res != undefined && res.data.code == 1000) {
                                this.getData();
        ...
        watch: {
            '$route' (to, from) {
                if (to.path == "/essantialOriginal" && this.$route.query.works != 1) {
                    this.getData();
                }
            }
        }
