    ...
    <div class="container">
        ...
        <div class="materialList">
            <div class="handle-box" style="margin-top: 10px">
                <span class="text">物料类型列表</span>
                <el-button round type="primary" @click="add" style="margin-bottom: 10px">新增物料类型</el-button>
            </div>
            <div class="materialTable">
                <el-table v-loading="loading" :data="tables" border style="width:100%">
                    ...
                    <el-table-column label="物料类型编号" prop="number" align="center"></el-table-column>
                    <el-table-column label="物料类型名称" prop="type" align="center"></el-table-column>
        ...
        <el-dialog title="新增物料类型" @close="closeing" :visible.sync="editVisible" width="24%">
...
<script>
    export default {
        ...
        methods: {
            ...
            getData(){
                this.$http.post('/productType/searchProductTypePager', this.search).then((res) => {
            ...
            updateStatus(index, row) {
                this.$http.post('/productType/status/update', {
                    id: row.id
                }).then((res) => {
                    if (res != undefined && res.data.code == 1000) {
            ...
            insert(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$http.post('/productType/insertProductType', this.addForm).then((res) => {
                            if (res != undefined && res.data.code == 1000) {
                                this.getData();
