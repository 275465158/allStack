            ...
            <el-row :gutter="30">
                ...
                <el-col :span="6">
                    <el-form-item label="产品类型">
                        <el-select v-model="form.type" placeholder="数据来自产品类型模块" disabled>
                            <el-option
                ...
                <el-col :span="6">
                    <el-form-item label="物料名称" prop="materialName" disabled>
            ...
            <div v-show="local" class="technologyBox">
                ...
                >
                    <el-table-column
                        ...
                        :label="process.processFormatName==''?('参数'+(index+1)) :process.processFormatName"
...
export default {
    ...
    methods: {
        ...
        insert() {
            ...
            this.saveLoading = true;
            this.$http
                .post("/materialInfo/materialUpgraded", this.form)
                .then(res => {
        ...
        addProcess() {
            ...
            if (this.processContentJson) {
                json = JSON.parse(this.processContentJson);
                json["id"] = 0;
                json["工艺序号"] = stepFlag[this.processInfo.length];
                json.checkStatus = 0;
                json.price = 0;
                for (let key in json) {
    ...
    watch: {
        $route(to, form) {
            if (
                to.path === "/materialUpgraded" &&
                this.$route.query.works !== 1
            ) {
