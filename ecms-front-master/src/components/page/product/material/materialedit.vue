<template>
    <div class="container materialadd">
        ...
        <el-form v-loading="loading" :model="form" ref="form" label-width="100px" :rules="rules">
            <el-row :gutter="30">
                ...
                <el-col :span="6">
                    <el-form-item label="工厂物料编号" prop="factoryMaterialCode">
                        <el-input v-model="form.factoryMaterialCode" :disabled="disableFlag"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                ...
                <el-col :span="6">
                    <el-form-item label="原图材料">
                        <el-input v-model="form.originalMaterial" :disabled="disableFlag"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="单位">
                        <el-input v-model="form.materialUnit" :disabled="disableFlag"></el-input>
                    </el-form-item>
                </el-col>
                <el-col>
            ...
            <el-button v-if="editParamFlag" size="small" @click="addParameterName()">添加参数</el-button>
            <el-table :data="dynamicParameterName" border style="width:100%" height="250">
                ...
                <el-table-column label="参数值">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.materialParamNameValue" :disabled="disableFlag"></el-input>
                    </template>
                </el-table-column>
                ...
                this.$http
                    ...
                    .then(res => {
                        if (res != undefined && res.data.code == 1000) {
                            ...
                            //2 是待审核,可以修改 3 审核未通过,不能修改
                            if (this.form.auditingStatus == 2){
                                this.disableFlag = false
                            }
                            if (this.form.auditingStatus == 3){
                                this.editParamFlag = false
                            }
                            console.log("------",this.editParamFlag);
