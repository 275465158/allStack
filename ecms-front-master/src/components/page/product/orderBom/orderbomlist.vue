    ...
    <div class="table">
        <div class="container">
            ...
            <el-table v-loading="loading" :data="tableData" border stripe style="width: 100%">
                ...
                <el-table-column align="center" prop="sellerStatus" label="状态"/>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.loading = true
                this.$http.post('seller/order/bomPager', this.search).then((res) => {
            ...
            updateInfo(index, row) {
                this.$router.push({path:'/editOrderBom',query:{id:row.id}});
            },
            detail(index, row) {
                this.$router.push({path:'/orderBomSearch',query:{id:row.id}});
            },
            delivery(index, row){
