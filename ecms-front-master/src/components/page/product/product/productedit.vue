            ...
            <el-row :gutter="30">
                ...
                <el-col>
                    <el-form-item label="状态:">
                        <el-select v-model="form.source" @change="openTable($event)" placeholder="请选择" disabled>
    ...
    export default {
        ...
        methods: {
            ...
            insert(){
                ...
                this.$http.post("/materialInfo/updateMaterial", this.form).then((res) => {
