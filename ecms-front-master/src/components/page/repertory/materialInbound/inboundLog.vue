    ...
    <div class="table">
        <div class="container">
            ...
            <el-table v-loading="loading" :data="tables" border style="width:100%">
                ...
                <el-table-column prop="storageLocation" label="入库位置">
                </el-table-column>
                ...
                <el-table-column prop="userName" label="入库操作人">
                </el-table-column>
...
<script>
    export default {
        data() {
            return {
                tableData: [],
                url: "/materialRepertoryInboundlog/like",
                pages: 1,
                search: {
                    pageSize:20,
                    materialCode:'',
        ...
        watch: {
            '$route' (to, search) {
                if (to.path == '/inboundLogList') {
                    ...
                    if(this.repertoryName != newRepertoryName){
