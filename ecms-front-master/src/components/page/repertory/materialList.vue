    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tables" border style="width:100%">
                ...
                <el-table-column prop="materialBom.originalMaterial" label="材质">
                </el-table-column>
            ...
            <div class="pagination">
                <el-pagination @current-change="handleCurrentChange" layout="total,prev, pager, next" :total="pages">
                </el-pagination>
            </div>
            <!-- 编辑弹出框 -->
            <el-dialog title="入库" :visible.sync="inboundVisible" width="50%">
                <el-form ref="inboundForm" :model="inboundForm" label-width="100px">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item  v-for="(project,index) in inboundForm.materielParams" :key="index" :offset="1" :label="project.parameterName==''?('规格'+(index+1)+':'):project.parameterName">
