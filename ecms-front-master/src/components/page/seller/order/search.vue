            ...
            <div class="handle-box">
                <el-form :inline="true" ref="customerForm" :model="orderForm" class="demo-form-inline" :rules="rules">
                    ...
                    <el-form-item label="商标:">
                        <el-input disabled v-model="orderForm.tradeMark"/>
                    </el-form-item>
                    ...
                    <el-form-item label="附件:">
                        ...
                        <el-button v-if="orderForm.fileName != ''"  @click="downloadFile">下载</el-button>
                    </el-form-item>
                </el-form>
            </div>
          ...
          this.$http.get(this.url + this.currentId).then(res => {
              if (res != undefined && res.data.code == 1000) {
                  if (res.data.data.orderInfo != null) {
                      ...
                      this.orderForm.fileName = utils.getFileName(this.orderForm.fileName);
                  } else {
                      this.orderForm = {
                          id: "",
                          contractId: "",
