    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tables" border stripe style="width: 100%">
                ...
                <el-table-column align="center" prop="name" label="送货方式"/>
        ...
        <el-dialog title="新增送货方式" @close="closeing" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                <el-form-item label="送货方式:" prop="name">
...
<script>
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$http.post("/sellerDelivery/searchPager",this.search).then((res) => {
            ...
            updateStatus(index, row) {
                this.$http.post('/sellerDelivery/status/update', {
                    id: row.id
                }).then((res) => {
                    if (res != undefined && res.data.code == 1000) {
            ...
            insert(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$http.post('/sellerDelivery/insertDelivery', this.form).then((res) => {
                            if (res != undefined && res.data.code == 1000) {
                                this.getData();
