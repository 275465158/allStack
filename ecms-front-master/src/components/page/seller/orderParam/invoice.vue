    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tables" border stripe style="width: 100%">
                ...
                <el-table-column align="center" prop="name" label="发票名称"/>
        ...
        <el-dialog title="新增发票类型" @close="closeing" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                ...
                <el-form-item label="税率（%）" prop="taxRate">
                    <el-input type="number" v-model.number="form.taxRate"></el-input>
                </el-form-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$http.post("/sellerInvoice/searchPager",this.search).then((res) => {
            ...
            updateStatus(index, row) {
                this.$http.post('/sellerInvoice/status/update', {
                    id: row.id
                }).then((res) => {
                    if (res != undefined && res.data.code == 1000) {
            ...
            insert(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$http.post('/sellerInvoice/insertSii', this.form).then((res) => {
                            if (res != undefined && res.data.code == 1000) {
                                this.getData();
