<template>
    <div class="table">
        <div class="container">
            <!--<div class="handle-box">
                <el-form :inline="true" :model="search" class="demo-form-inline">
                    ...
                    <el-input v-model="search.employeId"></el-input>
                    </el-form-item>
                    ...
                    <el-button round @click="getData">搜索</el-button>
                </el-form>
                
            </div>-->
            <div class="handle-box">
                <span class="el-form-item__label">付款周期</span>
                <el-button round type="primary" @click="add">新增</el-button>
            </div>
            <el-table :data="tables" border style="width: 100%">
                <el-table-column align="center" prop="id" label="序号" sortable>
                </el-table-column>
                <el-table-column align="center" prop="periodName" label="付款周期">
                </el-table-column>
                <el-table-column align="center" prop="periodDays" label="付款时间（天）">
                </el-table-column>
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="新增付款周期" @close="closeing" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :rules="rules" :model="form" label-width="100px">
                <el-form-item label="付款周期:" prop="periodName">
                    <el-input v-model="form.periodName"></el-input>
                </el-form-item>
                <el-form-item label="付款时间（天）:" prop="periodDays">
                    <el-input v-model="form.periodDays"></el-input>
                </el-form-item>
...
export default {
  data() {
    return {
      tableData: [],
      url: "/purchase/payment/period/list",
      editVisible: false,
        rules: {
            periodName: [
  ...
  methods: {
    ...
    updateStatus(index, row) {
      this.$http
        .post("/purchase/payment/period/status/update", {
          id: row.id,
          status: row.status
        })
        .then(res => {
    ...
    // 保存编辑
      insert(formName) {
          this.$refs[formName].validate((valid) => {
              if (valid) {
                  this.$http.post('/purchase/payment/period/insert', this.form).then((res) => {
